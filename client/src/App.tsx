          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-6 md:py-8 pb-20 sm:pb-8">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <div className="mb-4 sm:mb-6 md:mb-8 animate-fade-in flex justify-center">
                <TabsList className="inline-flex items-center justify-center bg-card border border-border rounded-lg sm:rounded-xl px-2 sm:px-4 py-1 shadow-sm hover:shadow-lg transition-all duration-300 gap-0.5 sm:gap-1">
                  <TabsTrigger 
                    value="dashboard" 
